...
**Next phase**: Phase 94 — the shared indexed-EA timeout investigation (4 independent repro cases now: JMP/JSR, MULS/MULU, DIVS/DIVU — worth tackling given the strong cross-instruction evidence), then Scc, PEA, LEA, MOVEM.l, MOVEtoSR. TRAP/RTE/RTR supervisor-state harness limitation remains separately tracked.
