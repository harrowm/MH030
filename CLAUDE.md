...
**Next phase**: Phase 92 — MULS/MULU/DIVS/DIVU (likely share one root cause in `eu_mul_div.sv`), then Scc, PEA, LEA, MOVEM.l, MOVEtoSR, then the JMP/JSR indexed-EA IFU-redirect stall. TRAP/RTE/RTR supervisor-state harness limitation remains separately tracked (Phase 93).
